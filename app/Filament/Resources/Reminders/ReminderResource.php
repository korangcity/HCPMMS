...
class ReminderResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'یادآورها';

    protected static ?string $modelLabel = 'یادآور';

    protected static ?string $pluralModelLabel = 'یادآورها';

    protected static string|null|\UnitEnum $navigationGroup = 'پیگیری';
