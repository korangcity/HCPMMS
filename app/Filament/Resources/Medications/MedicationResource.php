...
class MedicationResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'داروها';

    protected static ?string $modelLabel = 'دارو';

    protected static ?string $pluralModelLabel = 'داروها';

    protected static string|null|\UnitEnum $navigationGroup = 'درمان';
